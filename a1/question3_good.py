...
for n in range(3, 41):
    ...
    p_n = power_of_two * sqrt(2 * ((previous_perimeter / power_of_two)**2) /
                              (1 + sqrt(1 - (previous_perimeter / power_of_two)**2)))
